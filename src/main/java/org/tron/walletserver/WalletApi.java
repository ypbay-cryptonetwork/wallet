package org.ypbay.walletserver;
...
import org.ypbay.api.GrpcAPI.TransactionSignWeight.Result.response_code;
...
import org.ypbay.common.crypto.Sha256Sm3Hash;
import org.ypbay.common.crypto.sm2.SM2;
import org.ypbay.common.utils.Base58;
import org.ypbay.common.utils.ByteArray;
import org.ypbay.common.utils.TransactionUtils;
...
import org.ypbay.core.config.Parameter.CommonConstant;
import org.ypbay.core.exception.CancelException;
...
import org.ypbay.protos.Protocol.Transaction.Result;
import org.ypbay.keystore.CheckStrength;
import org.ypbay.keystore.Credentials;
import org.ypbay.keystore.Wallet;
import org.ypbay.keystore.WalletFile;
...
import org.ypbay.protos.contract.StorageContract.BuyStorageBytesContract;
import org.ypbay.protos.contract.StorageContract.BuyStorageContract;
...
import org.ypbay.protos.contract.StorageContract.SellStorageContract;
...
import org.ypbay.protos.Protocol.ChainParameters;
import org.ypbay.protos.Protocol.DelegatedResourceAccountIndex;
import org.ypbay.protos.Protocol.Exchange;
import org.ypbay.protos.Protocol.Key;
import org.ypbay.protos.Protocol.Permission;
...
import org.ypbay.protos.Protocol.Witness;
...
public class WalletApi {
  ...
  private Transaction signTransaction(Transaction transaction)
    ...
    while (true) {
      ...
      byte[] passwd = org.ypbay.keystore.StringUtils.char2Byte(password);
      org.ypbay.keystore.StringUtils.clear(password);
      if (isEckey) {
      ...
      org.ypbay.keystore.StringUtils.clear(passwd);
