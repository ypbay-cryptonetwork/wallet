...
import org.ypbay.common.utils.AbiUtil;
...
import org.ypbay.core.exception.EncodingException;
import org.ypbay.core.exception.ZksnarkException;
import org.ypbay.core.zen.ShieldedAddressInfo;
import org.ypbay.core.zen.ShieldedNoteInfo;
import org.ypbay.core.zen.ShieldedTRC20NoteInfo;
import org.ypbay.core.zen.ShieldedTRC20Wrapper;
import org.ypbay.core.zen.ShieldedWrapper;
import org.ypbay.core.zen.ZenUtils;
...
import org.ypbay.keystore.StringUtils;
...
import org.ypbay.walletserver.WalletApi;
...
public class Client {
  ...
  private void assetIssue(String[] parameters)
    ...
    if (parameters == null || parameters.length < 12) {
      ...
      System.out.println("TrxNum and AssetNum represents the conversion ratio of the ypbay to the asset.");
...
//          "Note: Please append the param for constructor tightly with byteCode without any space");
  ...
  private void getSpendingKey() {
    while (true) {
      byte[] skBytes = org.ypbay.keystore.Wallet.generateRandomBytes(32);
